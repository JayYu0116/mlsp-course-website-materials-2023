	...
	return (
		<div className="py-2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<h2 className="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl my-2">
				Challenge Final Report &#40;40%&#41;
			</h2>
			<span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-green-100 text-green-800">
				Due Date
			</span>
			<p className="text-xl leading-7 text-gray-500 mb-4">
			Wow, we're already at the end of the semester. We can't wait to read what you've accomplished with your projects. The final report will be due on December 13th, 2022 at 11:59 PM EST.
			</p>
			<p className="text-xl leading-7 text-gray-500 mb-4">
			Below, we've enumerated several items that your midterm report must include. Your submission must follow the&nbsp;
				...
				and not be less than two pages (recommand 4-6 pages). References and appendix do not count towards your limit. Your team's midterm report should be submitted as a PDF using Canvas. Each group only needs to submit one copy of the report. You can submit your report as many times as you need before the deadline. Please name your PDF "final_{"{group number}"}.pdf". Your report will be graded with the following things in mind:
			</p>
